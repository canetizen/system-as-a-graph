...
from shared.types.identifiers import SystemVersionRef, system_version
from vae.operations_panel.src.adapters.postgres.tables import (
    production_jobs,
    source_status_entries,
    working_scopes,
)
from vae.operations_panel.src.model.production_job import JobStatus, ProductionJob
from vae.operations_panel.src.model.source_status import (
    Accessibility,
    SourceStatus,
