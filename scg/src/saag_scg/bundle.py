"""
Description: Component bundle publishing the SCG CSU's services into the framework.
...
from saag_scg.api.routes import build_router


@ComponentFactory("saag-scg-factory")
@Provides(ApiRouterProvider)
@Instantiate("saag-scg")
class ScgBundle:
    """This CSU as one framework component (SDD §3.2.1).
