"""
Description: Component bundle publishing the VAE-03 CSU's services into the framework.
...
@ComponentFactory("saag-vae-03-factory")
@Provides(ApiRouterProvider)
@Instantiate("saag-vae-03")
class VaeDesignAnalyzerBundle:
    """This CSU as one framework component (SDD §3.6.3).
