"""
Description: Component bundle publishing the ADP CSU's services into the framework.
...
from saag_adp.api.routes import build_router


@ComponentFactory("saag-adp-factory")
@Provides(ApiRouterProvider)
@Instantiate("saag-adp")
class AdpBundle:
    """This CSU as one framework component (SDD §3.4.1).
