"""
Description: Component bundle publishing the VAE-02 CSU's services into the framework.
...
from saag_vae_design_verifier.api.routes import build_router


@ComponentFactory("saag-vae-02-factory")
@Provides(ApiRouterProvider)
@Instantiate("saag-vae-02")
class VaeDesignVerifierBundle:
    """This CSU as one framework component (SDD §3.6.2).
