...
**4.2.4 Handling of Critical Requirements**: the CSCI's security-critical requirement (LDAP-based authentication/authorization, `../requirements/SRS.md` 3.2.6.3, `../design/SDD.md` §4.3 EXT-IF-06) is tracked with the same rigor as any other CDR.md item (CDR-21) and must be resolved before the VAE increment's coding activity begins.
