...
**Framework host for the SaaG CSCI**

Starts the component framework, installs whichever CSU distributions are present, assembles the CSCI's external REST surface from the endpoints they publish, and owns its background-operation worker. Not a CSU: satisfies no SRS requirement.
...
One independently built and independently installable distribution, `saag-platform`.
