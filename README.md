# saag_vae_design_analyzer

**VAE-03 — Design Analyzer**

Read-only simulation and observational analysis using Analytical Evaluation Data. SRS VAE-03.1–21. Consumes INT-IF-05. Scheduled for SDP Increment 6.
...
One independently built and independently installable distribution, `saag-vae-design-analyzer`.
