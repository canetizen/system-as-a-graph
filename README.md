# saag_csm_data_binder

**CSM-02 — Analytical Data Binder**

Binds Analytical Evaluation Data onto the Core System Model without altering it, preserving provenance. SRS CSM-02.1–6. Consumes INT-IF-04. Scheduled for SDP Increment 5.
...
One independently built and independently installable distribution, `saag-csm-data-binder`.
