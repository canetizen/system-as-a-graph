# saag_vae_design_verifier

**VAE-02 — Design Verifier**

Read-only rule-based verification against the Core System Model. SRS VAE-02.1–22. Consumes INT-IF-05. Scheduled for SDP Increment 3.
...
One independently built and independently installable distribution, `saag-vae-design-verifier`.
