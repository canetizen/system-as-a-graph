# saag_csm_model_manager

**CSM-01 — Model Manager**

Builds the node-relationship Core System Model from Model Setup Data and serves it for read access. SRS CSM-01.1–31. Consumes INT-IF-01, provides INT-IF-05. Scheduled for SDP Increment 2.
...
One independently built and independently installable distribution, `saag-csm-model-manager`.
