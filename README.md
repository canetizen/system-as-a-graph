...
Stores and catalogues System Field Records uploaded from the field. SRS FRD.1–5. Provides INT-IF-03. Scheduled for SDP Increment 5.
...
One independently built and independently installable distribution, `saag-frd`.
