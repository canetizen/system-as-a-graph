"""
Description: Component bundle publishing the CSM-02 CSU's services into the framework.
...
from saag_csm_data_binder.api.routes import build_router


@ComponentFactory("saag-csm-02-factory")
@Provides(ApiRouterProvider)
@Instantiate("saag-csm-02")
class CsmDataBinderBundle:
    """This CSU as one framework component (SDD §3.5.2).
