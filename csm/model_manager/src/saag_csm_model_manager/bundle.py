"""
Description: Component bundle publishing the CSM-01 CSU's services into the framework.
...
@ComponentFactory("saag-csm-01-factory")
@Provides(ApiRouterProvider)
@Instantiate("saag-csm-01")
class CsmModelManagerBundle:
    """This CSU as one framework component (SDD §3.5.1).
