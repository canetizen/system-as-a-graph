"""
Description: Component bundle publishing the FRD CSU's services into the framework.
...
@ComponentFactory("saag-frd-factory")
@Provides(ApiRouterProvider)
@Instantiate("saag-frd")
class FrdBundle:
    """This CSU as one framework component (SDD §3.3.1).
